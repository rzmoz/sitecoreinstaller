...
namespace SitecoreInstaller.App.Pipelines.Steps.Install
{
    ...
    public class CopyLicensefile : Step
    {
        protected override void InnerInvoke(object sender, EventArgs args)
        {
            ...
            Services.Website.CopyLicenseFileToDataFolder(license as BuildLibraryFile, Services.ProjectSettings.Folders.Data, Services.ProjectSettings.LicenseConfigFile);
        }
    }
}
