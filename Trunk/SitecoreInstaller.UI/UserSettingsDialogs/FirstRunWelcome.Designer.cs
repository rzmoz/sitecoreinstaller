namespace SitecoreInstaller.UI.UserSettingsDialogs
{
    partial class FirstRunWelcome
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbxDescription.Text = "Please finish these next few important steps to set up SitecoreInstaller.\r\n\r\nSett" +
    "ings can be changed later if necessary.";
            // 
            // lblTitle
            // 
